...
// File paths
const TIMINGS_FILE = path.join(__dirname, '../native/data/lessons/beginner-greetings-timings.json');
const LESSON_FILE = path.join(__dirname, '../native/data/lessons/beginner-greetings.json');
const BACKUP_FILE = path.join(__dirname, '../native/data/lessons/beginner-greetings.json.backup');
...
function main() {
  ...
  "characters": [
    ...
    console.log('🚀 Starting timing update process...');
